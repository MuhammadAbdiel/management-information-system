        ...
        <form action="/transactions" method="POST" class="form-horizontal">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="customer_id">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="item_id">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity"
                  name="quantity" placeholder="Quantity Here" value="{{ old('quantity') }}">
                @error('quantity')
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select class="select2 form-control custom-select" style="width: 100%; height:36px;"
                  ...
                  @if (old('transaction_status') == 0)
                  <option value={{ 0 }} selected>Failed</option>
                  <option value={{ 1 }}>Pending</option>
                  <option value={{ 2 }}>Process</option>
                  <option value={{ 3 }}>Success</option>
                  @elseif (old('transaction_status') == 1)
                  <option value={{ 0 }}>Failed</option>
                  <option value={{ 1 }} selected>Pending</option>
                  <option value={{ 2 }}>Process</option>
                  <option value={{ 3 }}>Success</option>
                  @elseif (old('transaction_status') == 2)
                  <option value={{ 0 }}>Failed</option>
                  <option value={{ 1 }}>Pending</option>
                  <option value={{ 2 }} selected>Process</option>
                  <option value={{ 3 }}>Success</option>
                  @elseif (old('transaction_status') == 3)
                  <option value={{ 0 }}>Failed</option>
                  <option value={{ 1 }}>Pending</option>
                  <option value={{ 2 }}>Process</option>
